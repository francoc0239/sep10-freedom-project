            ...
            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
              <div className="carousel-inner">
                ...
                <div className="carousel-item active">
                  <img src="https://picsum.photos/300/200" className="d-block w-100 img-fluid custom-img" alt="..." />
                ...
                <div className="carousel-item">
                  <img src="https://picsum.photos/300/200" className="d-block w-100 size" alt="..." />
